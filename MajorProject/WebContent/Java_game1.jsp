...
<nav class="navbar navbar-light bg-light" style="opacity: 80%">
  <div style="opacity: 100%">
    <marquee  style="font-family:Book Antiqua; font-size: 0.7rem" scrollamount="2"><h3><i>Learning today for a better tomorrow, results in tranquillity.... Happy Learning</i></h3></marquee>
  </div>
</nav>
